...
namespace UltraGroup.Infrastructure.Migrations
{
    ...
    [Migration("20240803044127_UpdatesRelations")]
    partial class UpdatesRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UltraGroup.Core.Domain.Entities.ClientEntity", b =>
                {
                    ...
                    b.Property<int?>("TP_DocumentTypeEntityID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TP_DocumentTypeEntityID");
            ...
            modelBuilder.Entity("UltraGroup.Core.Domain.Entities.ClientEntity", b =>
                {
                    ...
                    b.HasOne("UltraGroup.Core.Domain.Entities.TP_DocumentTypeEntity", null)
                        .WithMany("Clients")
                        .HasForeignKey("TP_DocumentTypeEntityID");
