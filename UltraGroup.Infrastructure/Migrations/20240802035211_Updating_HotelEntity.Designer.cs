...
namespace UltraGroup.Infrastructure.Migrations
{
    ...
    [Migration("20240802035211_Updating_HotelEntity")]
    partial class Updating_HotelEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UltraGroup.Core.Domain.Entities.ClientEntity", b =>
                {
                    ...
                    b.Property<string>("Client_IDNumber")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("UltraGroup.Core.Domain.Entities.HotelEntity", b =>
                {
                    ...
                    b.Property<DateTime>("Htl_CheckIn")
                        .HasColumnType("datetime2");

                    b.Property<string>("Htl_CheckOut")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("UltraGroup.Core.Domain.Entities.RoomEntity", b =>
                {
                    ...
                    b.Property<int>("TP_RoomEntityID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UltraGroup.Core.Domain.Entities.BookingEntity", b =>
                {
                    b.HasOne("UltraGroup.Core.Domain.Entities.ClientEntity", "ClientEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("UltraGroup.Core.Domain.Entities.RoomEntity", b =>
                {
                    b.HasOne("UltraGroup.Core.Domain.Entities.TP_RoomEntity", "TP_RoomEntity")
                        .WithMany()
                        .HasForeignKey("TP_RoomEntityID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TP_RoomEntity");
                });
